...
const Message = () => {
    ...
    return (
        <div>
            <div className="lg:flex h-[93vh] overflow-hidden ">
                {/* Side Left */}
                <div className="w-[100%] h-[40%] lg:w-[40%] lg:h-full xl:w-[25%] bg-gray-800 p-4 overflow-y overflow-y-auto">
                    {/* Search bar */}
                ...
                {/* Chat Section */}
                <div className="w-[100%] h-[60%] lg:w-[60%] lg:h-full xl:w-[75%] p-4 flex flex-col bg-white ">
                    {/* Chat header */}
                    <div className="text-2xl font-bold mb-4 text-center text-black">
                        Message
                    </div>
